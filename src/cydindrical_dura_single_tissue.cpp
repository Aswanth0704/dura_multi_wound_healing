...
int main(int argc, char *argv[])
{
    ...
    std::string mesh_filename = "cylin_dura_multi_wound_normal_mesh.mphtxt";
...
//			}
	...
	std::stringstream ss;
	std::string filename = "wound_1_output"+ss.str()+"_";

    // // check the bc and wound initial conditions
    // std::string tag = "REF";

    // std::string filename_step  = "wound_1_output_" + tag + ".vtk";
    // std::string filename_step2 = "wound_1_output_second_" + tag + ".vtk";
